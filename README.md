Portafolio de proyectos de analiticas de datos

El proyecto incluye cinco ejercicios distintos en R, abarcando varios enfoques de análisis de datos. Los ejercicios cubren:

Limpieza y análisis de datos de una empresa de cuidado de la piel.

Análisis poblacional de países.

Ingresos de atletas destacados.

Modelos de regresión para eficiencia de combustible.

Web scraping y análisis de información de la Fórmula 1.

Cada ejercicio proporciona insights mediante visualizaciones y estadísticas, apoyando decisiones estratégicas en diversos campos con un enfoque integral en la ciencia y la ingeniería de datos
